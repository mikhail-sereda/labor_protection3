...
class FrameRegistration(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.button_instructions = ctk.CTkButton(self, text="", width=40, height=40, font=('Arial', 22),
                                                 fg_color="#63c0f2", border_width=1, image=self.ico_instructions,
                                                 command=None)
        self.label_registration = ctk.CTkLabel(self,
                                               text='Регистрация',
                                               font=('Arial', 32, "bold"))
        ...
        self.entry_user_patronymic = ctk.CTkEntry(self, placeholder_text="Отчество",
                                                  width=365, height=50, font=('Arial', 22))
        self.combo_profession = ctk.CTkComboBox(self, values=self.list_profession,
                                                width=365, height=50,
                                                dropdown_font=('Arial', 22), font=('Arial', 22))

        self.button_start_exam = ctk.CTkButton(self, text="Начать тест", font=('Arial', 22),
                                               border_width=1, fg_color="#63c0f2", command=self.start_test)
    ...
    def put_widgets(self):
        ...
        self.button_start_exam.grid(row=6, column=1, padx=4, pady=4, ipadx=20, ipady=15)
