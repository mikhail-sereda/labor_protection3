...
class FrameMain(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.master = master
        self.ico_setting = ctk.CTkImage(
            light_image=Image.open("static/img/ico_setting3.png"),
            dark_image=Image.open("static/img/ico_setting3.png"),
            size=(40, 40),
        )
        self.label_main = ctk.CTkLabel(
            self, text="Проверка знаний по охране труда", font=("Arial", 32, "bold")
        )
        self.button_settings = ctk.CTkButton(
            ...
            fg_color="#63c0f2",
            border_width=1,
            image=self.ico_setting,
            command=self.put_frame_menu,
        )
        self.button_start = ctk.CTkButton(
            self,
            text="Приступить к проверке знаний",
            font=("Arial", 22),
            border_width=1,
            fg_color="#63c0f2",
